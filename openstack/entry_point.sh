...
sleep 1
java $JAVA_ARGS -Xbootclasspath/a:/etc/perspective/rest -jar /usr/share/perspective/perspective-rest/perspective-rest.jar >> /var/log/perspective/perspective-rest.log 2>&1 &
